...
type DebugFlags struct {
	...
	CFGOHash              string `help:"hash value for debugging continuous feature guided optimizations" concurrent:"ok"`
	...
	CFGODevirtualize      int    `help:"enable continuous feature guided devirtualization; 0 to disable, 1 to enable interface devirtualization, 2 to enable function devirtualization" concurrent:"ok"`
