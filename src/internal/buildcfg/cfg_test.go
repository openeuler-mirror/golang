...
func TestConfigFlags(t *testing.T) {
	...
	if goarm64().Version != "v8.0" || goarm64().LSE != true || goarm64().Crypto != false || goarm64().Rcpc != false || goarm64().RPRFM != false || goarm64().ABIInternal != false {
	...
	os.Setenv("GOARM64", "v8.0,lse,abiinternal")
	if goarm64().Version != "v8.0" || goarm64().LSE != true || goarm64().ABIInternal != true {
		t.Errorf("Wrong parsing of GOARM64=v8.0,lse,abiinternal")
	}
	...
	os.Setenv("GOARM64", "v8.0,lse,rprfm")
	if goarm64().Version != "v8.0" || goarm64().LSE != true || goarm64().RPRFM != false {
		t.Errorf("Wrong parsing of GOARM64=v8.0,lse,rprfm")
	}
	os.Setenv("GOARM64", "v8.9,lse,rprfm")
